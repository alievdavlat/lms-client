  ...
  return (
    <div>
        ...
        <div className='w-full flex items-center justify-center mt-2'>
            ...
            <div className='w-[90px] h-[80px] rounded-full bg-[#497DF2] flex items-center justify-center'>
        ...
        <div className='m-auto flex items-center justify-around'>
            {
              Object.keys(verifyNumber).map((key , index) => (
                ...
                key={key}
                ref={inputRefs[index]}
                className={`w-[65px] h-[65px] bg-transparent border-[3px] rounded-[10px] flex text-black dark:text-white justify-center text-[18px] font-Poppins text-center  outline-none
                ${
                  invalidError 
                  ?
